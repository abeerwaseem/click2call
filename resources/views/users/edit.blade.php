...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
           <form method="POST" action="{{ route('edit-user-post',['user' => $user->id]) }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('sip_username') is-invalid @enderror" name="sip_username" value="{{ (old('sip_username')) ? old('sip_username') : $user->sip->sip_username }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('sip_password') is-invalid @enderror" name="sip_password" value="{{ (old('sip_password')) ? old('sip_password') : $user->sip->sip_password }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('sip_address') is-invalid @enderror" name="sip_address" value="{{ (old('sip_address')) ? old('sip_address') : $user->sip->sip_address }}" required>
